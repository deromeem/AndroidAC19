...
public class MesMessagesRecusActivity extends ListActivity {
    ...
    private static final String TAG_TASK = "mes_messages_recus";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes_messages_recus);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // Toast.makeText(MesMessagesRecusActivity.this, "Messages aid : "+aid, Toast.LENGTH_LONG).show();
                ...
                // envoi de la requete à l'activité suivante
                in.putExtra("TAG_TASK",TAG_TASK);
    ...
    class LoadItems extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            // super.onPreExecute();
            pDialog = new ProgressDialog(MesMessagesRecusActivity.this);
            ...
            // Toast.makeText(MesMessagesRecusActivity.this, "URL de l'API : " + apiUrl, Toast.LENGTH_LONG).show();
        }
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            if (json != null) {
                Toast.makeText(MesMessagesRecusActivity.this, json.toString(), Toast.LENGTH_LONG).show();  // TEST/DEBUG
                try {
            ...
            if (success == 1) {
                ...
                try {
                    ...
                    for (int i = 0; i < items.length(); i++) {
                        ...
                        String objet = obj.getString(TAG_OBJET);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    adapter = new SimpleAdapter(
                            MesMessagesRecusActivity.this, itemsList,
                            R.layout.list_message_recu_item, new String[]{TAG_ID, TAG_DATE, TAG_OBJET, TAG_AUTEUR},
                            new int[]{R.id.aid, R.id.date, R.id.objet, R.id.auteur});
