...
public class MessageActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TAG_TASK = in.getStringExtra("TAG_TASK");
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            if (success == 1) {
                ...
                try {
                    ...
                    objet = obj.getString(TAG_OBJET);
                    auteur = obj.getString(TAG_AUTEUR);
                    contenu = obj.getString(TAG_CONTENU);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    txtObjet = (TextView) findViewById(R.id.objet);
                    txtAuteur = (TextView) findViewById(R.id.auteur);
                    txtContenu = (TextView) findViewById(R.id.contenu);
