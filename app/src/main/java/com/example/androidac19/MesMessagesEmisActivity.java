...
public class MesMessagesEmisActivity extends ListActivity {
    ...
    private static final String TAG_TASK = "mes_messages_emis";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes_messages_emis);
    ...
    class LoadItems extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            // super.onPreExecute();
            pDialog = new ProgressDialog(MesMessagesEmisActivity.this);
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            if (json != null) {
                Toast.makeText(MesMessagesEmisActivity.this, json.toString(), Toast.LENGTH_LONG).show();  // TEST/DEBUG
                try {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    adapter = new SimpleAdapter(
                            MesMessagesEmisActivity.this, itemsList,
